    ...
    return <section className="mx-auto max-w-2xl px-4 sm:pb-6 lg:max-w-7xl lg:px-8 ">
        <div className="mb-8 flex flex-wrap justify-between md:mb-16">
            <div className="mb-6 flex w-full flex-col justify-center sm:mb-12 lg:mb-0 lg:w-1/3 lg:pb-24 lg:pt-48">
                ...
                <p className="max-w-md leading-relaxed text-gray-500 xl:text-lg">Handcrafted and best products from <br /> <span className=" font-bold">NextGen</span> </p>
            </div>
            <div className="flex mb-12 w-full md:mb-16 lg:w-2/3">
                <div className="relative left-12 top-12 z-10 -ml-12 overflow-hidden rounded-lg bg-gray-100 shadow-lg md:left-16 md:top-16 lg:ml-0">
                    <Image
                        src={urlFor(ImageData.image1).url()}
                        alt="Hero Image"
                        width={400}
                        height={400}
                ...
                <div className="overflow-hidden rounded-lg bg-gray-100 shadow-lg">
                    <Image
                        src={urlFor(ImageData.image2).url()}
                        alt="Hero Image"
                        width={400}
                        height={400}
                        className="h-full w-full object-cover object-center"
